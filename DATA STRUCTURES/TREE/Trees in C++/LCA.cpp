...
//we store path of both the nodes in two different arrays
//now we get the last element that is same for both the arrays
...
TreeNode* findLCAutil(TreeNode* root,int n1,int n2)
{
    ...
    if(root->data==n1 || root->data==n2)       //this basically searches for n1 or n2 and returns that node
        return root;
...
int main()
{
    ...
    cout<<findLCA(t,n1,n2)->data<<endl;
